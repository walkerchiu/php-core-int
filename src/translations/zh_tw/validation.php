...
return [
    ...
    |
    | Reference: https://github.com/caouecs/Laravel-lang/blob/master/src/zh-TW/validation.php
    */
    ...
    */
    ...
    'success'          => '操作成功完成！',
    'not_allowed'      => '操作不被允許！',
    'password_rule'    => ':attribute 至少須含有 1 個大寫字母、1 個小寫字母和 1 個數字。',
    'required_atleast' => '包含 :attribute 在內，至少應有一項欄位為必填。',
    'opposite'         => ':attribute 和 :value 必為相反值。',
    'not_same_length'  => ':attribute 和 :value 的長度不一致。'
];
